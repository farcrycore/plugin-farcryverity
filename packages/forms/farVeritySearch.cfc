<cfcomponent displayname="Search Form" hint="The search form for searching through the verity index" extends="farcry.core.packages.forms.forms" output="false">
	...
	<cfproperty ftSeq="4" ftFieldset="General" name="orderBy" type="string" default="rank" hint="The sort order of the results" ftLabel="Sort Order" ftType="list" ftList="rank:Relevence,custom3 DESC:Date" />
