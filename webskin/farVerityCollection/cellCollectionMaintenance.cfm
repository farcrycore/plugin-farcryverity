...
<a href="##" onclick="$('SelectedObjectID#Request.farcryForm.Name#').value='#stobj.objectid#';$('FarcryFormSubmitButtonClicked#Request.farcryForm.Name#').value='deleteCollection';forms.#Request.farcryForm.Name#.submit();" title="Delete">D</a>
