...
|| DESCRIPTION || 
$Description: farVerityLog Type 
Log of Verity searches.
$

|| DEVELOPER ||
$Developer: Geoff Bowers (modius@daemon.com.au) $
--->
<cfcomponent extends="farcry.core.packages.types.types" displayname="Verity Search Log" hint="Log of Verity searches." bSchedule="false" bFriendly="false" bSystem="true" output="false">
<!------------------------------------------------------------------------
type properties
------------------------------------------------------------------------->	
...
<cfproperty ftseq="8" ftfieldset="Collection Log" name="suggestedquery" type="string" hint="Verity suggested query string." required="no" default="" ftlabel="Suggested Query" ftdisplayonly="true" />
