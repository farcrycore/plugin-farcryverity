...
<cfset oVerityLog=createObject("component", "farcry.plugins.farcryverity.packages.types.farVerityLog") />
<cfset oVerityLog.createData(stproperties=stprops, bAudit=false) />
