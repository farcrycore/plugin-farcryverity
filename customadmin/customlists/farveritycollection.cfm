...
<ft:objectadmin 
	...
	permissionset="news"
	title="Verity Collections: #lcase(application.sysinfo.machinename)#"
	columnList="title,collectiontypename,builttodate,lIndexProperties,benablesearch,collectiontype"
